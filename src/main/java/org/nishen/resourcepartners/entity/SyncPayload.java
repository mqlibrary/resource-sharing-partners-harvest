...
public class SyncPayload
{
	...
	private Map<String, List<ResourcePartnerChangeRecord>> changes;

	public SyncPayload(Map<String, Partner> changed, Map<String, Partner> deleted,
	                   Map<String, List<ResourcePartnerChangeRecord>> changes)
	{
	...
	public Map<String, List<ResourcePartnerChangeRecord>> getChanges()
	{
		return changes;
	}

	public void setChanges(Map<String, List<ResourcePartnerChangeRecord>> changes)
	{
		this.changes = changes;
	}
